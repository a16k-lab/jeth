...
class StructFixedArrField {
  ...
  @view recLen(k: u256): u256 { return this.recs[k].length; }
  @view getId(k: u256, i: u256): u64 { return this.recs[k][i].id; }
  @view getData(k: u256, i: u256, j: u256): u256 { return this.recs[k][i].data[j]; }
}
`;
